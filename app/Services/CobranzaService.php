...
class CobranzaService
{
    ...
    public function registrarPago(
        ...
        return DB::transaction(function () use ($venta, $pagosInput, $estadoManual, $userId, $empresa) {
            ...
            Movimiento::create([
                ...
                'estado'           => 'activo',
                'empresa'          => $empresa,
                'caja_id'          => $venta->caja_id ?? session('caja_id'),
     ...
     * Ajusta el campo `ajuste` para que total_a_cobrar baje exactamente en $monto
    ...
    public function reducirSaldo(
        ...
        return DB::transaction(function () use ($venta, $monto, $userId, $empresa) {
            ...
            // Bajar ajuste para que total_a_cobrar disminuya en $monto
